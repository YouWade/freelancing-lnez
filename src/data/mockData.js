...
export const ORDERS_MOCK_DATA = [
  {
    ...
    totalPrice: 590,
    products: [
      { id: 1, image: Images.productImage1 },
      { id: 2, image: Images.productImage2 },
      { id: 3, image: Images.productImage3 },
      { id: 4, image: Images.productImage4 },
    ],
  ...
  },
  {
    ...
    totalPrice: 590,
    products: [
      { id: 5, image: Images.productImage5 },
      { id: 6, image: Images.productImage6 },
    ],
    actions: ['edit', 'cancel'],
  },
  {
    ...
    totalPrice: 590,
    products: [
      { id: 7, image: Images.productImage7 },
    ],
  ...
  },
  {
    ...
    totalPrice: 590,
    products: [
      { id: 8, image: Images.productImage8 },
      { id: 9, image: Images.productImage9 },
      { id: 10, image: Images.productImage10 },
      { id: 1, image: Images.productImage1 },
    ],
    actions: ['review', 'refund', 'confirm'],
  },
...
export const MY_ORDER_MENU = [
  ...
  { key: 'pending_receipt', label: '待收貨', icon: 'folderDownload' },
